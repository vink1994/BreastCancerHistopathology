...
dataset = DDN_DS_PROCESS(DDN_SHAPE, 1, range(4), proj_dir, DDN_DS_Variant, DDN_NumSeed, DDN_TTrat, augment=True)
...
models = []
for i in range(5):
    model = load_model("E:/PHD/shwetha_hyst_code/V6/trained_weights/100X_Mag.h5".format(i), custom_objects={'f1': f1, 'precision': precision, 'recall': recall})
...
def plot_confusion_matrix(cm,
    ...
    plt.savefig("100X - DDN confusion matrix.jpg", dpi=150)
    plt.show()
