            ...
            for ix2, b in enumerate(self.MALIGNANT_SUB_CLASSES):
                ...
                for c in os.listdir(path1):
                    ...
                    for img_name in os.listdir(path2):
                        ...
                        for DDN_iter_param, benign_class in enumerate(self.MALIGNANT_SUB_CLASSES):
...
dataset = DDN_DS_PROCESS(DDN_SHAPE, 1, range(1), BASE_DIR, DDN_DS_Variant, DDN_NumSeed, DDN_TTrat, augment=True)
