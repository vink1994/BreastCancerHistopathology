...
def DDN_customFeat_Input2(input_feature):
    ...
    avg_pool = Lambda(lambda DDN_init_param1: K.mean(x, axis=3, keepdims=True))(pscstm_ft_vctr)
    assert avg_pool.shape[-1] == 1
    max_pool = Lambda(lambda DDN_init_param1: K.max(x, axis=3, keepdims=True))(pscstm_ft_vctr)
...
def DDN_Mal_Model(input_shape=(224,224,3), n_classes=4):
    ...
    DDN_init_param2 = Dense(n_classes, activation="softmax", name="PSMDL")(x)
