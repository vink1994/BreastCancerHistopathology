...
models = []
for i in range(5):
    model = load_model("E:/PHD/shwetha_hyst_code/V6/trained_weights/40X_Mag.h5".format(i), custom_objects={'f1': f1, 'precision': precision, 'recall': recall})
...
def plot_confusion_matrix(cm,
    ...
    plt.savefig("40X - confusion matrix.jpg", dpi=150)
    plt.show()
